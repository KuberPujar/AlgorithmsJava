...
0 <= limit <= 109
 */
public class LongestContinousSubArrayWithAbsoluteDiffLessThanOrEq {
    ...
    public static void main(String[] args) {
        LongestContinousSubArrayWithAbsoluteDiffLessThanOrEq solution = new LongestContinousSubArrayWithAbsoluteDiffLessThanOrEq();
        int[] nums = {8, 2, 4, 7};
        int limit = 4;
