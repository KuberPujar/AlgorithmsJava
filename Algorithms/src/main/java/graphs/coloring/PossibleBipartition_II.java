 ...
 */
public class PossibleBipartition_II {
    ...
    public static void main(String[] args) {
        PossibleBipartition_II solution = new PossibleBipartition_II();
        int n = 4;
        int[][] dislikes = {{1, 2}, {1, 3}, {2, 4}};
        System.out.println(solution.possibleBipartition(n, dislikes)); // Output: true
    }
}
