...
public class MaximumScoreFromRemovingStones {
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solution.maximumScore(2, 4, 6)); // Output: 6
        System.out.println(solution.maximumScore(4, 4, 6)); // Output: 7
        System.out.println(solution.maximumScore(1, 8, 8)); // Output: 8
    }
}
