...
-104 <= nums[i] <= 104
 */
public class ConstrainedSequenceSum {

    //Java solution using dynamic programming with a monotonic queue
    ...
    //Space optimized version using the same logic but modifying the input array directly
    ...
    public static void main(String[] args) {
        ConstrainedSequenceSum solution = new ConstrainedSequenceSum();
        int[] nums1 = {10, 2, -10, 5, 20};
        int k1 = 2;
        System.out.println(solution.constrainedSubsetSum(nums1, k1)); // Output: 37

        int[] nums2 = {-1, -2, -3};
        int k2 = 1;
        System.out.println(solution.constrainedSubsetSum(nums2, k2)); // Output: -1

        int[] nums3 = {10, -2, -10, -5, 20};
        int k3 = 2;
        System.out.println(solution.constrainedSubsetSum(nums3, k3)); // Output: 23
    }
}
