...
public class RingsAndRods {
    public static int countRodsWithAllColors(String rings) {
        // There are 10 rods, index 0 to 9
        HashSet<Character>[] rods = new HashSet[10];
        for (int i = 0; i < 10; i++) {
            rods[i] = new HashSet<>();
        }

        // Process each color-position pair
    ...
    public static void main(String[] args) {
        ...
        System.out.println("Output: " + countRodsWithAllColors(rings1)); // Output: 1

        // Example 2
        String rings2 = "B0R0G0R9R0B0G0";
        System.out.println("Output: " + countRodsWithAllColors(rings2)); // Output: 1

        // Example 3
        String rings3 = "G4";
        System.out.println("Output: " + countRodsWithAllColors(rings3)); // Output: 0
    }
}
